...
float4 PS(VertexOut pin, uniform bool gUseTexure, uniform bool gShowNormal) : SV_Target
{
    ...
    ComputePointLight(gMaterial, gPointLight, pin.PosW, pin.NormalW, toEye,
				A, D, S);
    ...
    ComputeSpotLight(gMaterial, gSpotLight, pin.PosW, pin.NormalW, toEye,
				A, D, S);
